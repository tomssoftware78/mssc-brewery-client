...
public class BlockingRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    private ClientHttpRequestFactory clientHttpRequestFactory() {
        ...
        connectionManager.setMaxTotal(maxTotalConnections); //maximum 100 connections
        connectionManager.setDefaultMaxPerRoute(defaultMaxTotalConnections); //maximum 20 connections per route
